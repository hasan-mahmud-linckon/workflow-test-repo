...
A small test repository for workflow experiments.
...
- **Pull Requests:** Include a clear description, related issue (if any), testing steps, and screenshots when relevant.
- **Issues:** Open issues for bugs and feature requests with reproducible steps.
- **License & Contact:** Add a license if applicable and provide a maintainer contact in the repo settings or PR template.

Thank you for contributing — small, focused changes are appreciated.
